...
export function TaskGrid({ tasks, isLoading, onTaskUpdated, onTaskDeleted }: TaskGridProps) {
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-100 mb-2 group-hover:text-cyan-300 transition-colors">
                    {task.title}
                  </h3>
                ...
                <div className="flex items-center gap-1 ml-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Button
                    ...
                    className="text-gray-500 hover:text-cyan-400 h-8 w-8 p-0"
                  >
